  ...
  <body>
    ...
    <header role="banner">
      ...
      <nav class="navbar navbar-expand-md navbar-dark bg-light">
        <div class="container">
          <a class="navbar-brand" href="index.php">LuxuryHotel</a>
       ...
       <li class="no-bullet">
                <?php 
                     ...
                     echo "<button type='button' class='loggedinbtn' id='loggedinbtn'>Logged In</button>";
                     }
                     else echo "<button type='button' class='loginbtn' id='loginbtn'>Login</button>";     
                ?> 
            </ul>
        ...
        <div class="row mb-5">
          <div class="col-md-4">
            <div class="post-entry">
              <a href="blog-single.php"><img src="../images/img_3.jpg" alt="Image placeholder" class="img-fluid"></a>
              <div class="body-text">
                <div class="category">Rooms</div>
                <h3 class="mb-3"><a href="blog-single.php">New Rooms</a></h3>
          ...
          <div class="col-md-4">
            <div class="post-entry">
              <a href="blog-single.php"><img src="../images/img_6.jpg" alt="Image placeholder" class="img-fluid"></a>
              <div class="body-text">
                <div class="category">News</div>
                <h3 class="mb-3"><a href="blog-single.php">New Staff Added</a></h3>
                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsum deserunt illo quis similique dolore voluptatem culpa voluptas rerum, dolor totam.</p>
                <p><a href="#" class="btn btn-primary btn-outline-primary btn-sm">Read More</a></p>
              </div>
            </div>
          ...
          <div class="col-md-4">
            <div class="post-entry">
              <a href="blog-single.php"><img src="../images/img_5.jpg" alt="Image placeholder" class="img-fluid"></a>
              <div class="body-text">
                <div class="category">New Rooms</div>
                <h3 class="mb-3"><a href="blog-single.php">Big Rooms for All</a></h3>
                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsum deserunt illo quis similique dolore voluptatem culpa voluptas rerum, dolor totam.</p>
                <p><a href="#" class="btn btn-primary btn-outline-primary btn-sm">Read More</a></p>
              </div>
            </div>
